    ...
    var startGame = function() {
      ...
      for(var i = 0; i < enemyNames.length; i++) {
        ...
        if (playerHealth > 0) {
          ...
          // pick new enemy to fight based oon the index of the enemyNames array
        ...
        // if player is not alive, break out of the loop and let endGame function run
          ...
          var endGame = function() {
            ...
            if (playerHealth > 0) {
              ...
              // askplayer if they'd like to play again
             ...
             var shop = function() {
               ...
               // use switch case tp carry out action
               switch (shopOptionPrompt) {
                 case 'REFILL':
                 case 'refill':
                   if (playerMoney >= 7) {
                     window.alert("Refiling health by 20 for 7 dollars.");
